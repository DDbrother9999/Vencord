...
export default definePlugin({
    name: "StarHelper",
    description: "Star's Super-Duper Amazing Helper (to help Super-Duper Amazing People)",
    version: "1.0.0",
    authors: [Devs.Star],
    ...
    async start() {
        ...
        createTagCommand({ name: "lost-email-account", message: "If you have lost access to your email please contact !support and provide them with: DOB, purchase history, and the email you lost access to. If you are missing any of these things or have forgotton the email you lost access to there is nothing we can do to you help." });
        ...
        createTagCommand({ name: "ping-op", message: "" });
